...
With photonic_sim you can calculate the electric and magnetic field of optical waves in arbitrary 1D photonic structures with arbitrary angle of incidence. The simulator assumes non-magnetic materials in current-free spaces.

It can be useful for simulating:
